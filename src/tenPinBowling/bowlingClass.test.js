...
test ("All numbers and multiple strikes and extra strike with multiple strikes", () => {
    expect(bolos.bowlingScoreStrikeWithExtraStrikeAndStrike("X 54 X 62 72 44 X 54 63 X XX")).toBe(138);
});
